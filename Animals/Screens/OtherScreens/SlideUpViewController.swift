...
class SlideUpViewController: UIViewController {
    ...
    let imageView = AnimalsImageView(image: UIImage.init(systemName: "checkmark.circle")!)
    lazy var correctLabel = AnimalsLabel(text: "Correct", textAlignment: .center, fontSize: 20, weight: .bold)
    let continueBtn = AnimalsButton(backgroundColor: UIColor.systemGreen, title: "Continue")
