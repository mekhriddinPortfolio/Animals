...
class TakeQuizViewController: UIViewController {
    ...
    lazy var questionInfoLabel = AnimalsLabel(text: "", textAlignment: .center, fontSize: 20, weight: .medium)
    lazy var button1 = AnimalsButton(backgroundColor: UIColor.init(hex: "F92968"), title: "1")
    lazy var button2 = AnimalsButton(backgroundColor: UIColor.init(hex: "F92968"), title: "2")
    lazy var button3 = AnimalsButton(backgroundColor: UIColor.init(hex: "F92968"), title: "3")
    lazy var button4 = AnimalsButton(backgroundColor: UIColor.init(hex: "F92968"), title: "3")
    lazy var buttons: [AnimalsButton] = [button1, button2, button3, button4]
    lazy var questionLabel = AnimalsLabel(text: "Question number: \(count < 20 ? count + 1 : count)", textAlignment: .center, fontSize: 20, weight: .medium)
    ...
    func generate() {
        count += 1
        if count > 10 {
            presentAlertOnMainThread(title: score > 8 ? "Well Done" : (score > 6 ? "Practice More" : (score > 4 ? "Poor Preformance" : "Failure")), message: "You have answered \(score) out of 10 questions correctly.", buttonTitle: "OK")
